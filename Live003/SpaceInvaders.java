...
public class SpaceInvaders extends JPanel implements Runnable, KeyListener {
	...
	public void paintComponent(Graphics g2) {
		...
		if (ganhou) {
			...
			g.drawString("VOCÊ TERMINOU O JOGO!!! Fechando em " + fechandoEm + " segundos", MainJogo.monitor.getWidth()/2 - 300, MainJogo.monitor.getHeight()/2 );
		...
		if (perdeu) {
			g.setColor(Color.white);
			g.setFont(minhaFonte);
			g.drawString("VOCÊ É MUITO RUIM!!! Fechando em " + fechandoEm + " segundos", MainJogo.monitor.getWidth()/2 - 300, MainJogo.monitor.getHeight()/2 );
